			  ...
			  <div class="w3-bar w3-card w3-left-align w3-large">
			  	<div class="w3-row">
			  		...
			  		<div class="w3-col w3-padding w3-right" style="width:30%">
			  			<div class="w3-col w3-margin-right " style="width:45%">
			  				<div class="w3-border w3-round-xxlarge w3-hover-shadow">
						    	<span class="btn_login list_menu w3-button w3-large w3-hide-small w3-hover-none w3-text-white" onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><i class="fas fa-user-plus index_fontawe w3-margin-right list_menu" ></i>ĐĂNG KÍ</span>
						  	</div>
			  			</div>
