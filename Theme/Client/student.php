...
$sql = "SELECT * FROM intern_organization_requests WHERE status  = '3000' ORDER BY date_submitted DESC ";
$connect = new Connection();
$list = $connect->getData($sql);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <header>
        <div class="w3-top">
            <div class="w3-bar w3-left-align w3-large w3-light-green">
                <div class="w3-row">
                    <div class="w3-col w3-padding w3-green " style="width:20%"><a href="#"
                                                                                  class="w3-bar-item w3-button w3-hide-small w3-large w3-hover-none w3-hover-text-white"><b>OKANE
                                - Student</b></a></div>
                    <div class="w3-col w3-padding" style="width:80%">
                        <div class="w3-left w3-padding">
                            <span class="glyphicon glyphicon-home w3-text-white"></span><a href="index.php"
                                                                                           class="w3-text-white"><span
                                        class="w3-margin-left">HOMEPAGE</span></a>
                        </div>
...
<section>
    <div class="w3-display-container">
        <div class="w3-col w3-padding-64 w3-green w3-dark-grey w3-menu"
             style="width:20%;height: 630px;position: fixed;">
            <div class="w3-padding w3-light-grey w3-margin w3-round" style="height: 100px;">
                <div class="w3-quarter">
                    <img src="../../img/slide/Slide3-0.jpg" style="width:75%;height: 40px"
                         class=" w3-right w3-round-xxlarge">
                </div>
            ...
            <?php foreach ($list as $item) : ?>
                <div class="w3-padding  w3-margin w3-round w3-card w3-display-container" style="height:300px">
                    ...
                    <div class="w3-padding">
                        <div class="w3-quarter w3-padding">
                            <img src="../../img/partner/House3D.jpg" class="w3-image w3-border w3-hover-shadow"
                                 style="height: 150px;width: 100%;">
                            <div class="w3-center w3-margin-top">
                                <?php
                                $connect = new Connection();
                                $id = $item['organization_id'];
                                $query = "SELECT organization_name FROM intern_organization_requests, intern_organization_profile WHERE intern_organization_profile.id = '$id' group by organization_name";
                                $resultSet = mysqli_query($connect->Conn(),$query);
                        ...
                        <div class="w3-threequarter w3-padding">
                            ...
                            <p>Lương khởi điểm: <?php echo $item['salary'] ?> đ</p>
                            <p>Địa chỉ:
                                <?php
                                $connect = new Connection();
                                $id = $item['organization_id'];
                                $query = "SELECT address FROM intern_organization_requests, intern_organization_profile WHERE intern_organization_profile.id = '$id' group by organization_name";
                                $resultSet = mysqli_query($connect->Conn(),$query);
                                $row = mysqli_fetch_assoc($resultSet);
                                echo $row['address'];
                                ?>
                    ...
                    <button class="w3-btn w3-green w3-display-bottomright w3-margin"
                            onclick="document.getElementById('id02').style.display='block'">Xem chi tiết
                    </button>
...
<div id="id02" class="w3-modal w3-top" style="display: none">
    <div class="w3-modal-content">
        <div class="w3-container">
            <div class="w3-panel w3dâu-border-bottom">
            ...
            <div class="w3-panel w3-margin">
                <div class="w3-half">
                    <div class="w3-padding">
                        <img src="../../img/partner/inno.png" class="w3-image w3-border w3-hover-shadow"
                             style="height: 200px;width: 100%;">
                        <div class="w3-center w3-margin-top">Công ty InnoDigi</div>
                        <div class="w3-center w3-margin-top">Lorem Ipsum is simply dummy text of the printing and
            ...
            <button class="w3-btn w3-green w3-display-bottomright w3-margin" id="btn_register_job">Đăng kí ứng tuyển
            </button>
        </div>
